  ...
  class Builder < ::ActionView::Helpers::FormBuilder
    ...
    def link_to_add(*args, &block)
      ...
      @template.after_nested_form(association) do
        ...
        output << fields_for(association, model_object, :child_index => "new_#{association}", &@fields[association], :validate => self.options[:validate]) #HACK -Jesse. Try using self.options
